          ...
          <VerticalTimeline layout="2-columns">
            {timelineElements.map((element, index) => (
              <VerticalTimelineElement
                ...
                icon={
                  <img
                    className="absolute top-1/2 left-1/2 max-w-[unset] -translate-x-1/2 -translate-y-1/2 w-[108%]"
                    src={element.icon}
                    alt={t(element.key)}
                  />
                }
              >
                <h3 className="vertical-timeline-element-title opacity-75 text-base md:text-lg">
                  {t(`${element.key}`)}
                </h3>
                <p>
                  ...
                  ) : element.key === "homeHowItWorksCrypto" ? (
                    <Trans
                      i18nKey="homeHowItWorksCryptoText"
                      values={{ usdc: "USDC", usdt: "USDT" }}
